import { privacypolicy } from '../app/view/base/sourceLoaded';
...
export const createSignInPage = () => {
    ...
    <div class="title"></div>
        <div class="tabBar">
            ...
            <div class="left-container" on-down="onShow">
                ...
                <span on-tap="backPrePage"  style="color: fff">用户协议</span>
            </div>
        </div>
    ...
    // tslint:disable-next-line:no-inner-html
    elem.innerHTML = window.pi_sdk.config.isHorizontal ? content :(title + content + div);
