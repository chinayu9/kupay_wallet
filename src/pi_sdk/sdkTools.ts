import { inAndroidApp } from '../app/public/config';
...
export const createSignInPage = () => {
    ...
    <div class="title"></div>
        ...
        <div style="height: 100%;overflow-x: hidden;overflow-y: auto;-webkit-overflow-scrolling: touch;scroll-behavior: smooth;">
            <div style="font-size: 28px;margin: 30px 20px;white-space: pre-wrap;background: #ffffff;border-radius: 12px;padding: 60px 30px;">${inAndroidApp ? inAndroid :inIOS}</div>
