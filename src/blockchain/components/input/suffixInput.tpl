<div w-class="pi-input-box input-focused-{{it1.focused}}" class="pi-input">
    ...
    <div w-class="pi-input__suffixBox" on-tap="clearClickListener">
        <img w-class="pi-input__suffix" src="../../res/images/{{it.available ? 'icon_right2' : '30_gray'}}.png"/>
    </div>  
    {{end}}
    {{if it.isShow}}
    <div w-class="close-eyesBox" on-tap="showPassword">
        <img src="{{it.closeEye?'../../res/images/closeEyes.png':'../../res/images/openEyes.png'}}" w-class="close-eyes"/>
    </div>
    {{end}}
</div>