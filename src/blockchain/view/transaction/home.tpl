<div class="new-page" w-class="new-page" ev-back-click="backPrePage" ev-next-click="chooseAddrClick" ev-refresh-click="refreshClick">
    <div w-class="top-head">
        ...
        <app-components-topBar-topBar>{"title":{{topBarTitle}},background:"#fff",nextImg:"../../res/image/location.png",text:{{it.address}}}</app-components-topBar-topBar>
        <div w-class="head">
            <div w-class="show-container">
                <div w-class="quotes"><span>≈</span>&nbsp;{{it.currencyUnitSymbol}}{{it.rate}}/{{it.currencyName}}</div>
                {{if it.redUp}}
